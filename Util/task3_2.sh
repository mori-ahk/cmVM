avr-gcc -Os -Wall -DF_CPU=16000000UL -mmcu=atmega328p -DonTarget ../Tests/tvmstack.c ../HAL/hal.c ../HAL/out.c ../VM\ stack/vmstack.c ../BSL/_uart.c ../BSL/_cout.c ../BSL/_xtoa.c -o _cout.o
