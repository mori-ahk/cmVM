avr-gcc -Os -Wall -DF_CPU=16000000UL -mmcu=atmega328p -DonTarget ../Tests/TestInterman.c ../HAL/interman.c ../HAL/hal.c ../HAL/out.c ../BSL/_cout.c ../BSL/_xtoa.c -o TestInterman.o
